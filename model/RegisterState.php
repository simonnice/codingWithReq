...
class RegisterState {
    ...
    public function ValidateRegisterInputData($data) {
        ...
        if (empty($data['RegisterView::UserName']) == true && empty($data['RegisterView::Password']) == true) {
        ...
        } else if (strlen($data['RegisterView::UserName']) < 3) {
            throw new \Exception("Username has too few characters, at least 3 characters.");
        } else if (strlen($data['RegisterView::Password']) < 6) {
            throw new \Exception("Password has too few characters, at least 6 characters.");
        } else if ($data['RegisterView::Password'] != $data['RegisterView::PasswordRepeat']) {
